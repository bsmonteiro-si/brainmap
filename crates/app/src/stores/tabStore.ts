...
interface TabStoreState {
  ...
  openTab: (path: string, kind: "note" | "plain-file" | "pdf" | "excalidraw", title: string, noteType: string | null) => void;
...
function createFreshTab(path: string, kind: "note" | "plain-file" | "untitled" | "pdf" | "excalidraw", title: string, noteType: string | null): TabState {
  return {
    id: path,
    path,
    kind,
